...
describe("CsvFilter", () => {
    ...
    it("should remove a bill if any taxes are non decimal", () => {
        const billWithIncorrectIva: string = "1,02/05/2019,1008,810,19,,ACERLaptop,B76430134"
        const billWithIncorrectIgic: string = "1,02/05/2019,1008,810,,17,ACERLaptop,B76430134"
